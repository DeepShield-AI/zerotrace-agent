...
cp %pwd/output/target/x86_64-unknown-linux-musl/release/zerotrace-agent $RPM_BUILD_ROOT/usr/sbin/
cp %pwd/output/target/x86_64-unknown-linux-musl/release/zerotrace-agent-ctl $RPM_BUILD_ROOT/usr/sbin/
