...
cp %pwd/output/target/aarch64-unknown-linux-musl/release/zerotrace-agent $RPM_BUILD_ROOT/usr/sbin/
cp %pwd/output/target/aarch64-unknown-linux-musl/release/zerotrace-agent-ctl $RPM_BUILD_ROOT/usr/sbin/
